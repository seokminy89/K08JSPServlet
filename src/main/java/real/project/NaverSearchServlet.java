...
public class NaverSearchServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		String clientId = "oJk18vHdSHqaArMLGljT"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "wgDVSbJqtB"; //애플리케이션 클라이언트 시크릿값"
        ...
        //검색API의 요청 URL
        /*
        	파라미터 설명(네이버 개발자센터에 접속해서 API Document 참고할 것)
        		query : 검색어(필수사항)
        		display : 출력할 결과물의 갯수(디폴트:10)
