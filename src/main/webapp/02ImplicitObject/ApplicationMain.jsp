...
<body>
	...
	<!-- 
		이클립스에서는 우리가 직접 작성한 파일을 실행하는것이 아니라 
		.metadata 폴더 하위에 프로젝트와 동일한 환경을 만들어서 복사본 파일이 실행된다.
		따라서 아래의 물리적 경로는 .metadata 하위의 경로가 출력되게 된다.
	 -->
	...
	내장 객체는 _jspService()메서드내에서 생성된 지역변수 이므로
	더 넓은 지역인 선언부에서는 사용하려면 매개변수로 전달받아야 한다.
	*/
	...
	public String useImplicitObject(ServletContext app){
		/*
		방법2 : 스크립틀릿에서 메서드 호출 시 application 내장 객체를
		매개변수로 전달해서 사용한다.
		*/
