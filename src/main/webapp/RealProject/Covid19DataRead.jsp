...
<script>
$(function() {
	//jQuery UI의 데이트 피커 선언. 한국에서 사용하는 날짜포맷으로 변경
	...
	$('#submitBtn').click(function() {
		...
		/*
		replace()메소드는 기존에 하나 의 -만 지워주는데,
		/-/g 와 같은 정규표션식을 사용하면 문자열 내의 모든 -을 삭제할 수 있다
		비슷한 방법으로는 replaceAll()메서드를 사용할 수 있다.
		*/
...
function sucFuncXml(d) {
	...
	var decideCnt = new Array(); //누적확진자 수
	var deathCnt = new Array(); //누적사망자 수
	var accExamCnt = new Array(); //누적검사 수
