...
$(function() {
	...
	$.ajaxSetup({
		...
		type : "get",//전송방식
		contentType : "text/html;charset=utf-8;",//전송 방식에 따른 컨텐츠 타입.
...
function sucFuncJson(d) {
	...
	/*
	items키값의 데이터는 배열이므로 each메소드를 사용하여 갯수만큼 반복이 가능하다.
	$.each(배열데이터, function(반복시 index 반환, 반복시 해당 객체 반환)
	반복된 요소들은 str+= 를 사용해 하나의 문자열로 만들어 준다.	
	*/
