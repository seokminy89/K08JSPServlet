...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	선언부(Declaration) : 스트립틀릿이나 표현식에서 사용할 메서드를
		선언할 때 사용된다. 선언부에서 선언된 메서드는 해당 JSP가
		서블릿(Java파일)으로 변환될 때 멤버 메서드 형태로 기술된다.
--%>    
<%!
...
<body>
<%--
	스클립틀릿(Scriptlet) : 주로 JSP코드를 작성하고 실행할 때 사용하는 영역이다.
		스크립틀릿은 body, head 어디서든 사용할 수 있다.
		또한 <script>, <style>태그 내에서도 사용할 수 있다.
	...
	표현식 사용시 주의할 점은 문장 끝에 ;(세미콜론)을 쓰면 에러가 발생한다는 점.
--%>
<%
