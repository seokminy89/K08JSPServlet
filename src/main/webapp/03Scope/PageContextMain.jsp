...
/*
page영역
	:하나의 페이지에서만 영역이 공유되고 페이지 이동, 포워드 된 모든
...
/*
	page 영역을 포함한 4가지 영역에는 모든 데이터를 저장할 수 있다.
	Object 기반으로 차 후 값을 읽을 때는 해당 형으로 변환해야 한다.
*/
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<%
	//정수 데이터를 객체화할 때 Integer 클래스를 통해 자동 박싱/언박싱 할 수 있다. 
	...
	<ul>
		...
		<!-- Person 클래스의 경우 getter()를 통해 내용을 출력한다. -->
		<li>Person 객체 : <%= pPerson.getName() %>,<%= pPerson.getAge() %></li>
	</ul>
	
	<!-- 
	지시어를 통한 include는 포함할 페이지의 원본 소스를 그대로 현재 문서에 
